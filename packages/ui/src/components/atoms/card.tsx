...
export function Card(props: CardProps): JSX.Element {
    ...
    return (
        <div
            ref={ref}
            className="ui-w-full border-0 shadow-md h-full p-6 rounded-md bg-white flex gap-x-3"
            style={{
        ...
        >
            {props.cardType === 'icon' ? (
                <div
                    className="icon bg-success text-white rounded-full max-w-10 max-h-10 flex items-center justify-center">
		...
		S509.502,87.794,504.969,83.262z"/>
            ...
            ) : <div className="additional-element text-primary font-bold">
                {props.numberCard}
            </div>}

            <div className="flex flex-col gap-1">
                <p className="text-base-100 font-semibold text-md">{props.label}</p>
                <p className="text-sm text-neutral">{props.description}</p>
            </div>
        </div>
    );
}
